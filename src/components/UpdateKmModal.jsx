  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-end justify-center z-50 p-4 sm:items-center">
      <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl">
        <h3 className="font-bold text-gray-900 text-lg mb-1">Actualizar kilometraje</h3>
        <p className="text-sm text-gray-500 mb-4">Km actuales: {currentKm.toLocaleString()}</p>
